...
line_bot_api.push_message('U08e0b3334851a188dac8149bd83e74a0', TextSendMessage(text='你想找什麼樣的音樂'))
...
def handle_message(event):
    ...
    if re.match('熱門音樂',message):
        audio_message = AudioSendMessage(
            original_content_url='https://drive.google.com/file/d/1DpzoBJKfcsILJ2sRewS2Y4DSgQ7Uf1B7/view?usp=sharing',
            duration=81000
        )
        line_bot_api.reply_message(event.reply_token, audio_message)
    elif re.match('放鬆音樂',message):
        audio_message = AudioSendMessage(
            original_content_url='https://drive.google.com/file/d/1jvf8sEzy3L_Q8veHcdx28i6xKkjXCV9w/view?usp=drive_link',
            duration=81000
        )
        line_bot_api.reply_message(event.reply_token, audio_message)
    else:
